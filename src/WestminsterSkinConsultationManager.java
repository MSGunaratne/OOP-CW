...
public class WestminsterSkinConsultationManager implements SkinConsultationManager {
    ...
    private void launchGUI(ArrayList<Doctor> doctorArrayList, ArrayList<Consultation> consultationArrayList) {
        ...
        button2.addActionListener(e -> {
            ...
            createConsultationButton.addActionListener(e1 -> {
                //get values from all the input fields and validate
                String[] selectedDoctor = ((String) Objects.requireNonNull(comboBox.getSelectedItem())).split(" ");
                ...
                try {
                    ...
                    addThisConsultation = new Consultation(consultantDoctor, Objects.requireNonNullElseGet(addThisPatient, () -> new Patient(pNameTextField.getText(), pSNameTextField.getText(), patientDob, contactTextField.getText(), Integer.toString(++nextPatientID))), consultationDate, consultationTime, cost, notes);
